...
be reported to the project maintainer through **GitHub's private
reporting**: open a private security advisory on the repository
(**Security** tab → **Report a vulnerability**) if the report concerns a
security matter, or contact the maintainer directly via their GitHub
profile ([@ADJ189](https://github.com/ADJ189)) for conduct issues that
aren't appropriate for a public issue. All complaints will be reviewed
